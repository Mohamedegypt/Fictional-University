...
var magiSeacrh = new _Search.default();
...
/*#__PURE__*/
function () {
  // 1. describ and create/initiate our object
  function Search() {
  ...
  _createClass(Search, [{
    ...
    value: function events() {
      ...
      this.searchField.on('keyup', this.typpingLogic.bind(this));
    } //keyup fire one time even stack on click fire once
    //keydown fire more time even stack on click
    //3. methodes functions and action

  }, {
    key: "typpingLogic",
    value: function typpingLogic() {
    ...
    value: function openOverlay() {
      ...
      console.log('check how many time clicked');
    ...
    value: function closeOverlay() {
      ...
      console.log('hallo how many time clicked');
      this.isOverlayopen = false;
    }
  }, {
    key: "addSearchHtml",
...
function () {
  ...
  _createClass(MyNotes, [{
    ...
    value: function Events() {
      ...
      (0, _jquery.default)('#my-notes').on('click', '.update-note', this.updataNote.bind(this));
